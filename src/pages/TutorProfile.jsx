  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        experience:
          "7+ Years Tutoring AP Calculus, Differential Equations & Physics Mechanics",
        about:
          "Passionate mathematician and experienced university lecturer focused on intuitive conceptual understanding, problem-solving mastery, and score improvements for high school and undergraduate students.",
        subjects: [
          "Calculus I & II",
          "Linear Algebra",
      ...
      <div className="card bg-base-100 border border-base-200 p-8 rounded-3xl space-y-8 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 pb-6 border-b border-base-200 text-center sm:text-left">
          ...
          <div className="space-y-2 flex-1">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-1 text-amber-500 text-xs pt-1">
              ...
              <Star className="w-4 h-4 fill-amber-500" />
              <Star className="w-4 h-4 fill-amber-500" />
              <span className="text-base-content/70 font-bold ml-1.5">
                5.0 (38 Student Reviews)
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 bg-base-200/40 p-4 rounded-2xl border border-base-200">
              ...
              <div>
                ...
                <p className="text-xs text-base-content/80 mt-1">
                  {tutor.experience ||
                    "7+ Years Tutoring Higher Mathematics & College Prep"}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-base-content/70 leading-relaxed bg-base-200/30 p-5 rounded-2xl border border-base-200">
            {tutor.about ||
              "Dedicated educator focused on building lasting confidence and mastery. Tailors custom problem sets, mock exams, and real-time interactive problem walkthroughs."}
          </p>
        </div>
        ...
        <div className="pt-4 border-t border-base-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-xs text-base-content/60">
            Want this tutor for your requirement? Post a tuition or check their
            open availability.
          </span>
          <Link
            to="/dashboard/student/post-tuition"
            className="btn btn-primary btn-sm rounded-xl font-bold text-xs gap-1.5 shadow-sm"
          >
